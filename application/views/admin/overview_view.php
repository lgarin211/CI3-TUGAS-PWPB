...
<body>
    ...
    <div class="sidebar-header">
        <div class="d-flex justify-content-between">
            <div class="logo">
                <a href="index.html"><img src="<?php echo base_url('assets/mazer/dist/assets/images/logo/logo.png');?>" alt="Logo" srcset=""></a>
            </div>
            <div class="toggler">
                                    ...
                                    <tbody>
                                            ...
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="<?php echo base_url('assets/mazer/dist/assets/images/faces/5.jpg');?>">
                                                    </div>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="<?php echo base_url('assets/mazer/dist/assets/images/faces/2.jpg');?> ">
                                                    </div>
                ...
                <div class="card-body py-4 px-5">
                    <div class="d-flex align-items-center">
                        <div class="avatar avatar-xl">
                            <img src="<?php echo base_url('assets/mazer/dist/assets/images/faces/1.jpg');?>" alt="Face 1">
                        </div>
                        <div class="ms-3 name">
                ...
                <div class="card-content pb-4">
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="<?php echo base_url('assets/mazer/dist/assets/images/faces/4.jpg');?>">
                        </div>
                        <div class="name ms-4">
                    ...
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="<?php echo base_url('assets/mazer/dist/assets/images/faces/1.jpg');?>">
                        </div>
                        <div class="name ms-4">
